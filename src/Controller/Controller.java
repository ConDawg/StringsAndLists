...
//		changeTheList();
	...
	private void editTheList()
	{
		...
		removed = myKahoots.set(3, new Kahoot());
		removedTwo = myKahoots.set(4, new Kahoot());
		popup.displayText("The kahoot by " + removed.getCreator() + " was replaced with " + myKahoots.get(3).getCreator() + "'s Kahoot and the Kahoot by " + removedTwo.getCreator() + " was replaced by " + myKahoots.get(4).getCreator() + ".");
